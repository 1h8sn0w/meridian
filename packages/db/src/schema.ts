 ...
 * приїхав, тутешній відбиток застарілий сам. Рахує його клієнт зі ЗМІСТУ
 * плану — з клітинок і страв у них: у `week_plan` немає збіжного id, тож двоє,
 * що згенерували той самий тиждень офлайн, мали б різні відбитки на однаковому
 * списку.
 *
