 ...
 * не чекають ніколи (MER-46, MER-49). Мережа потрібна рівно для оболонки —
 * `index.html`, бандлів, іконок, — тож цей воркер кешує ЛИШЕ її.
 *
 ...
 * `index.html` однаковий для будь-якого маршруту: Caddy віддає той самий файл
 * через `try_files`, а маршрут визначає клієнтський роутер з адреси. */
const SHELL_HTML = '/'
