 ...
 *
 * Гардів на сервері немає й не буде: сесія живе на пристрої, а сервера
 * застосунку не існує взагалі (MER-45).
 */
...
export function AppGate() {
  ...
  switch (status) {
    ...
    case 'loading':
      // Той самий каркас, що й далі, — щоб шапка не блимала, поки читається
      // збережена сесія.
