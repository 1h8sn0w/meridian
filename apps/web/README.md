...
Кешується тільки оболонка й тільки за **білим списком** шляхів (`/assets/`,
`/icons/`, маніфест, HTML). Supabase і PowerSync у продакшні стоять на тому
самому походженні, тож чорний список рано чи пізно поклав би в кеш чужу сесію.
Решта правил і їх обґрунтування — у шапці [`public/sw.js`](public/sw.js).
